...
def get_release_quality(release_name, release_link=None):
    ...
    try:
        ...
        elif any(i in ['caMr Blamoip', 'tsrip', 'hdcam', 'hdts', 'dvdcam', 'dvdts', 'cam', 'telesync', 'ts'] for i in fmt): quality = 'CAM'
        ...
        if not quality:
            if release_link:
                ...
                if '1080' in release_link: quality = '1080p'
                    ...
                    elif any(i in ['caMr Blamoip', 'tsrip', 'hdcam', 'hdts', 'dvdcam', 'dvdts', 'cam', 'telesync', 'ts'] for i in release_link): quality = 'CAM'
                    else: quality = 'SD'
            else: quality = 'SD'
        info = []
